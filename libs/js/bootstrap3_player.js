...
(function ($) {'use strict';
    $('audio[controls]').before(function () {
        ...
        $(data_table).addClass('table');
        $(data_table).css("direction","rtl");
        $(data_table).css("font-family","'Droid Arabic Kufi', sans-serif");
        $(data_table).css("margin-top","35px");
        $(data_table).css("margin-bottom","30px");
        ...
        var addAlbumArt = function () {
            ...
            $(albumArt).addClass('thumbnail albumartimg');
            $(albumArt).attr('src', $(song).data('infoAlbumArt'));
            $(albumArt).css('width','150px');
            $(albumArt).css('height','150px');
            $(albumArt).css('margin','0px auto');
