	  			    	...
	  			    	<?php
	  			     	...
	  			     	?>   
	  						...
	  						?>
	  			     		...
	  			     		<center><img class="img-responsive" src="http://localhost/THESOCIALS/uploads/user_profiles/<?=$profpic;?>"></center>	 		
				    ...
				    <div class="panel-heading">
				      <?php 
                        if($profpic==''){
                       	...
                       	?>
                          <img src="http://localhost/THESOCIALS/uploads/user_profiles/<?=$profpic?>" style="max-height:40px;"> 
                       <?php
                       }
                       ?>
					 ...
					 <div class="panel-body" >
					  <?php	
					   if($postImage==''){
                          ...
                          ?>
                          <img src="http://localhost/THESOCIALS/uploads/post_images/<?=$postImage?>" style="max-height:100px;">  
				    ...
				    <div class="panel-heading">
					 ...
					 <?php	
					   if($postImage==''){
                           ...
                           <br>
                           <img src="http://localhost/THESOCIALS/uploads/post_images/<?=$postImage?>" style="max-height:200px;">  
