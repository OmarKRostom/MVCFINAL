				     ...
				     <div class="panel-heading">
				      <?php 
                       ...
                       if(($temp[0]->profile_pic)==''){
                       	...
                       	?>
                          <img src="uploads/user_profiles/<?=$temp[0]->profile_pic?>" style="max-height:40px;"> 
                       <?php
                       }
                       ?>
                        <a href="http://localhost/THESOCIALS/profile/view/<?=$temp[0]->user_id?>" style="color:black;margin-left:5px;"><?= $temp[0]->first_name." ".$temp[0]->last_name;?></a>
